...
from sklearn.cluster import KMeans  # Nueva importación para K-Means
...
st.markdown (
    "Esta aplicación realiza una auditoría de inversiones simuladas, detectando anomalías con **Isolation Forest**, aplicando reglas heurísticas y agrupando datos con **K-Means**.")
